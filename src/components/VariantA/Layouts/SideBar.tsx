  ...
  return (
    <div>
      ...
      <div
        className={`${
          sideBar ? "" : "-ml-64"
        } bg-[#2C2E33] fixed top-0 left-0 z-40 duration-300 w-64 h-screen border-[0.0625rem] border-[#2C2E33]`}
      >
        ...
        <div className="h-full px-3 py-10 overflow-y-auto">
          <ul className="space-y-2">
            <li>
              <Link to="/">
                <p className="flex items-center p-2 text-base font-normal rounded-lg hover:bg-[#5C5F66] hover:text-white text-gray-900 bg-gray-100">
                  <svg
                    aria-hidden="true"
      ...
      <div className={`${sideBar ? "md:ml-64" : ""} duration-300`}>
        {props.children}
      </div>
    </div>
  );
